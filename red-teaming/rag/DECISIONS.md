...
Scripts in this directory were developed using AI-assisted workflows as part of the engineering process. The architectural decisions, model selections, framework mappings, validation outcomes, and integration logic are my own. I reviewed and ran every script on my local hardware and validated outputs across multiple iterations.

See `DEVELOPMENT_NOTES.md` at the repository root for full disclosure.
