# 🛡️ RAG Adversarial Test Harness
...
I document the reasoning behind each model and version choice in [`DECISIONS.md`](./DECISIONS.md).
...
cd ~/rag_project/phase2
python run_all.py
```

Output is written to `~/rag_project/phase2/findings/phase2_findings.xlsx`.
...
- I refined the harness iteratively across multiple versions of the underlying lifecycle reference (currently at v4.9), driven by real assessment outputs and the errors I encountered along the way.
- I document the engineering trade-offs — model selection, judge architecture, isolation strategy for retrieval-modifying attacks, and known limitations — in [`DECISIONS.md`](./DECISIONS.md).

---

*Part of the [AI Security Assurance Labs](../../) portfolio.*
*See repository root [`DEVELOPMENT_NOTES.md`](../../DEVELOPMENT_NOTES.md) for AI-assisted development disclosure.*
